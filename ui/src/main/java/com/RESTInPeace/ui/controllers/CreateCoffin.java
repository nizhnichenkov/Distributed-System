...
import com.RESTInPeace.ui.constants.S3Constants;
...
public class CreateCoffin {
    ...
    public String createCoffin(final HttpServletRequest httpServletRequest,
                               ...
                               @RequestParam(value = "coffin_price") final String price) throws Exception {
        ...
        final String generatedImageName = String.format("%s%s%s%d%s",
                username,
                name,
                email,
                new Date().getTime(),
        ...
        final Coffin coffin = Coffin.builder()
                ...
                .userEmail(email)
                .image(String.format("%s/%s", S3Constants.S3_ADDRESS, generatedImageName))
                .build();
        ...
        ImageAPIUtils.sendPicture(picture, generatedImageName);
