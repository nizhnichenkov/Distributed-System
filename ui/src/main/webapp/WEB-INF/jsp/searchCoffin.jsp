            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-group">
                        <form action="\search">
                            <input type="text"
                            class="form-control search-bar search-bar-field field-0-style"
                            name="searchString" onsubmit="$('#searchForm').submit()"
                            placeholder="Search the catalogue..." value="${searchString}" />
                        </form>
                    </div>          
                    <div class="divider-h">
            ...
            <c:forEach var="record" items="${records}">
                <div class="row">
                    <div class="col-md-3 col-lg-2">
                        <p>
                                ${record.getCoffinInfo().getName()}
                        </p>
                    </div>
                    <div class="col-md-3 col-lg-3">
                        <c:choose>
                            <c:when test="${record.getCoffinInfo().getImage() eq null}">
                                <img src="img/lazyload-ph.png" data-src="img/placeholder-image.png"
                                     class="img-fluid mx-auto d-block lazyload" alt="coffn-image"/>
                            </c:when>
                            <c:otherwise>
                                <img src="${record.getCoffinInfo().getImage()}"
                                     data-src="${record.getCoffinInfo().getImage()}"
                                     class="img-fluid mx-auto d-block lazyload"
                                     alt="${record.getCoffinInfo().getImage()}"/>
                            </c:otherwise>
                        </c:choose>
                    ...
                    <div class="col-md-3 col-lg-3">
                        <p class="p-style">
                                ${record.getCoffinInfo().getDescription()}
                        </p>
                    </div>
                    <div class="col-md-3 offset-lg-0 col-lg-1">
                        <p>
                                ${record.getCoffinInfo().getPrice()} $
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="p-coffin-block-style">
                            Contact details:
                            <br>
                            Email: ${record.getUserInfo().getEmail()}
                            <br>
                            Name: ${record.getUserInfo().getName()}
                        </p>
                    </div>
                </div>
                <div class="divider-h">
